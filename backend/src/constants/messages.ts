...
export const Messages = {
  ...
  SUCCESS: {
    ...
    // Doctor Messages
    DOCTOR_SAVED: "Doctor saved successfully",
  ...
  ERROR: {
    ...
    MULTIPLE_DOCTORS_FOUND: "We found same name with more than 1 doctor please select one",
    ...
    FAILED_TO_FETCH_DOCTOR: "Failed to fetch doctor",
    ...
    EITHER_DOCTOR_ID_OR_NAME: "Either doctorId or doctorName is required",
    EITHER_USER_ID_OR_NAME: "Either userId or userName is required",
    AT_LEAST_ONE_ID_REQUIRED: "At least one of patientId, doctorId or leadId must be provided",
  },
  ...
  VALIDATION: {
    ...
    INVALID_DOCTOR_ID: "Invalid doctorId",
