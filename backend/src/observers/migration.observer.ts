...
import {
  ...
  KeyValidAuthenticationStrategy,
  MetaWebhookStrategy,
  OtpAuthenticationStrategy,
  PatientJWTAuthenticationStrategy,
  PatientOtpAuthenticationStrategy,
} from '../strategies'
...
export class MigrationObserver {
  ...
  registerAuthenticationStrategy() {
    ...
    registry.register(
      AuthenticationStrategy,
      new KeyValidAuthenticationStrategy(),
      AuthenticationStrategyType.KEY_VALID,
    )
    registry.register(
      AuthenticationStrategy,
      new PatientJWTAuthenticationStrategy(),
      AuthenticationStrategyType.PATIENT_JWT_AUTH,
    )
    registry.register(
      AuthenticationStrategy,
      new PatientOtpAuthenticationStrategy(),
      AuthenticationStrategyType.PATIENT_OTP_AUTH,
    )
  }
}
